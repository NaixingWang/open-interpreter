...
function_schema_qa = {
  "name": "qa_dft",
  "description":
  "Answer the technical questions about integrated circuit (IC) design-for-test (DFT),\
...
def setup_openai_coding_llm(interpreter):
    ...
    def coding_llm(messages):
        ...
        messages[0]["content"] += "\n\nSpecial Notes: \
                                    ...
                                    For **TECHNICAL** questions about integrated circuit (IC) testing, including design-for-test (DFT), Automatic Test Pattern Generation (ATPG), \
